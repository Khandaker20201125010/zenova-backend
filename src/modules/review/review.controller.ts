...
export class ReviewController {
  async createReview(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        ...
        .json(errorResponse("Failed to create review", error.message));
    }
  }
  ...
  async getProductReviews(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get product reviews", error.message));
    }
  }
  ...
  async getUserReviews(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get user reviews", error.message));
    }
  }
  ...
  async updateReview(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to update review", error.message));
    }
  }
  ...
  async deleteReview(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to delete review", error.message));
    }
  }
  ...
  async getRecentReviews(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get recent reviews", error.message));
    }
  }
  ...
  async getReviewStats(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get review stats", error.message));
    }
  }
  ...
  async getAllReviews(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get all reviews", error.message));
    }
  }
}
