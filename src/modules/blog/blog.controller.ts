...
export class BlogController {
  async createPost(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        ...
        .json(errorResponse("Failed to create blog post", error.message));
    }
  }
  ...
  async getPosts(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get blog posts", error.message));
    }
  }
  ...
  async getPostBySlug(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get blog post", error.message));
    }
  }
  ...
  async updatePost(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to update blog post", error.message));
    }
  }
  ...
  async deletePost(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to delete blog post", error.message));
    }
  }
  ...
  async getFeaturedPosts(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get featured posts", error.message));
    }
  }
  ...
  async getRecentPosts(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get recent posts", error.message));
    }
  }
  ...
  async getBlogStats(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get blog stats", error.message));
    }
  }
