...
export class ProductController {
  async createProduct(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        ...
        .json(errorResponse("Failed to create product", error.message));
    }
  }
  ...
  async getProductBySlug(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get product", error.message));
    }
  }
  ...
  async updateProduct(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to update product", error.message));
    }
  }
  ...
  async deleteProduct(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to delete product", error.message));
    }
  }
    ...
    try {
      ...
      if (!files || files.length === 0) {
        return res
          ...
          .json(errorMessageResponse("No files uploaded"));
      }
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to upload images", error.message));
    }
  }
  ...
  async removeProductImage(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      if (!imageUrl) {
        return res
          .status(StatusCodes.BAD_REQUEST)
          .json(errorMessageResponse("Image URL is required"));
      }
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to remove image", error.message));
    }
  }
  ...
  async getRelatedProducts(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get related products", error.message));
    }
  }
  ...
  async getFeaturedProducts(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get featured products", error.message));
    }
  }
  ...
  async toggleFavorite(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      if (!productId) {
        return res
          .status(StatusCodes.BAD_REQUEST)
          .json(errorMessageResponse("Product ID is required"));
      }

      const result = await productService.toggleFavorite(
        req.user.id,
        productId,
      );
      return res.status(StatusCodes.OK).json(result);
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to toggle favorite", error.message));
    }
  }
  ...
  async getUserFavorites(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json(errorResponse("Failed to get favorites", error.message));
    }
  }
