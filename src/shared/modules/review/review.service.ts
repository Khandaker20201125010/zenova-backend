...
export class ReviewService {
  async createReview(userId: string, productId: string, rating: number, comment?: string): Promise<ApiResponse> {
    try {
  ...
  async updateReview(id: string, userId: string, data: { rating?: number; comment?: string }): Promise<ApiResponse> {
    try {
  ...
  async getAllReviews(page: number = 1, limit: number = 20): Promise<ApiResponse> {
    try {
      const skip = (page - 1) * limit;
