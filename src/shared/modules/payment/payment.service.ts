...
export class PaymentService {
  async createPaymentIntent(userId: string, data: CreatePaymentInput): Promise<ApiResponse> {
    try {
  ...
  async getPayments(params: PaymentQueryParams, userId?: string): Promise<ApiResponse> {
    try {
      const {
        page = 1,
        limit = 10,
