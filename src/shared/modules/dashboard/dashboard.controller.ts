...
export class DashboardController {
  async getAdminDashboard(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get admin dashboard', error.message)
      );
    }
  }
  ...
  async getUserDashboard(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get user dashboard', error.message)
      );
    }
  }

  async getManagerDashboard(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get manager dashboard', error.message)
      );
    }
  }
  ...
  async getAnalytics(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get analytics', error.message)
      );
    }
  }
  ...
  async getSystemStatus(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get system status', error.message)
      );
    }
  }

  async getRevenueAnalytics(req: AuthRequest, res: Response): Promise<Response> {
    try {
      if (!req.user || req.user.role !== 'ADMIN') {
        return res.status(StatusCodes.FORBIDDEN).json(
          errorResponse('Insufficient permissions')
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get revenue analytics', error.message)
      );
    }
  }
  ...
  async getUserAnalytics(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get user analytics', error.message)
      );
    }
  }
  ...
  async getSalesAnalytics(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get sales analytics', error.message)
      );
    }
  }
  ...
  private calculateGrowthRate(data: any[]): number {
    ...
    const lastValue = data[data.length - 1]?.value || data[data.length - 1]?.users || data[data.length - 1]?.revenue || 0;
