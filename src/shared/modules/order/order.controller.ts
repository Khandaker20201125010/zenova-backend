...
export class OrderController {
  async createOrder(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to create order', error.message)
      );
    }
  }
  ...
  async getOrders(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get orders', error.message)
      );
    }
  }
  ...
  async getOrderById(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get order', error.message)
      );
    }
  }
  ...
  async updateOrderStatus(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to update order status', error.message)
      );
    }
  }
  ...
  async cancelOrder(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to cancel order', error.message)
      );
    }
  }
    ...
    try {
      ...
      if (!signature) {
        return res.status(StatusCodes.BAD_REQUEST).json(
          errorResponse('Stripe signature required')
        );
      }
  ...
  async getOrderStats(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get order stats', error.message)
      );
    }
  }
  ...
  async getUserOrders(req: AuthRequest, res: Response) {
    try {
      ...
      res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Failed to get user orders', error.message)
      );
    }
  }
}