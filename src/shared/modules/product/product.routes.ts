...
router.post('/favorites/toggle', authenticate, productController.toggleFavorite);
...
router.post('/:id/images', authenticate, authorize('ADMIN'), uploadMiddleware.multiple('images', 10), productController.uploadProductImages);
router.delete('/:id/images', authenticate, authorize('ADMIN'), productController.removeProductImage);
