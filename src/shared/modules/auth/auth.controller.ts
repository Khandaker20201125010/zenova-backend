...
export class AuthController {
  ...
  async socialLogin(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Social login failed', error.message)
      );
    }
  }
  ...
  async refreshToken(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Token refresh failed', error.message)
      );
    }
  }
  ...
  async requestPasswordReset(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Password reset request failed', error.message)
      );
    }
  }
  ...
  async resetPassword(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Password reset failed', error.message)
      );
    }
  }
  ...
  async changePassword(req: AuthRequest, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Password change failed', error.message)
      );
    }
  }
  ...
  async demoLogin(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json(
        errorResponse('Demo login failed', error.message)
      );
    }
  }
